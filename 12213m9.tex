...
\]}
\only<3->{\[
2^{2024} \equiv \text{?} \bmod 4, \quad 2^{2024} \equiv \text{?} \bmod 25
\]}
\only<4->{\[
2^{2024} = (2^2)^{1012} = 4^{1012} \equiv 0 \bmod 4
\]}
\end{frame}
...
\]
\only<2->{\[
2^{10} = 1024 \equiv 24 \equiv -1 \bmod 25
\]}
\only<3->{\[
2^{2024} = (2^{10})^{202} \cdot 2^4 \equiv (-1)^{202} \cdot 16 \equiv 16 \bmod 25
\]}
\end{frame}
