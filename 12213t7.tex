...
\]
\uncover<2->{The total cost should have been 
\[
\biggl(1.08+\frac{x}{100}\biggr)\cdot 60 = 60 \cdot 1.08 + \frac{3}{5}\cdot x. 
\]}
\uncover<3->{The difference between these costs was $0.72$ dollars, so 
\[
...
\]
\uncover<2->{\[
0.08 \cdot \frac{3}{5} \cdot x = 0.72
\]}
\uncover<3->{\[
x = 0.72 \cdot \frac{1}{0.08} \cdot \frac{5}{3} = \frac{0.72}{0.24} \cdot 5 = 3 \cdot 5 = \boxed{15}
\]}
\end{frame}
...
\begin{frame}{Key Concepts}
  \begin{itemize}
  \item Percents
  % We needed to understand percents to correctly interpret both costs in order to set up a single variable equation using their difference, which allowed us to solve for the unknown.
